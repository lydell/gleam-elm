...
pub fn spawn(task: Task(x, a)) -> Task(y, Id)
...
@external(javascript, "./process.ffi.mjs", "_Process_sleep")
pub fn sleep(duration: Float) -> Task(x, Nil)
...
@external(javascript, "./scheduler.ffi.mjs", "_Scheduler_kill")
pub fn kill(id: Id) -> Task(x, Nil)
